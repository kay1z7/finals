...
def wm(): 
    ...
    edit.text((150, 200), textt, ("white"), font=fontt)
...
def abt():
    my_label.after(1000, show_pic4)

def show_pic4():
    global my_im2
    my_im2 = PhotoImage(file='abt.png')
    my_label.config(image=my_im2)

myButton = Button(root, text='Watermark', padx=40, pady=20, command=wm)
myButton.pack(side=TOP)
myButton2 = Button(root, text='B/W', padx=40, pady=20, command=bw)
myButton2.pack(side=TOP)
myButton3 = Button(root, text='Size', padx=40, pady=20, command=sz)
myButton3.pack(side=TOP)
myButton4 = Button(root, text='about', padx=40, pady=20, command=abt)
myButton4.pack(side=TOP)
myButton5 = Button(root, text='exit', padx=40, pady=20, command= quit)
